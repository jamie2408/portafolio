    ...
    <v-container fluid>
      <div class="head">
        <div class="galaxy">
          ...
          <v-row style="height: 100vh" id="inicio">
            ...
            >
              <div>
                <v-img class="foto" src="logo.png"></v-img>
              </div>
            </v-col>
          </v-row>
        </div>
      ...
      >
        <v-col align-self="center" cols="12" md="6">
          <div>
            <v-img class="jamie" src="jamie.jpeg"></v-img>
          </div>
        </v-col>

        <v-col align-self="center" cols="8" md="3">
          <h2 class="titulos-sobremi">Sobre mi</h2>
          <br />
      ...
      >
        <v-col align-self="center" cols="8" sm="3" class="mx-16 mb-4">
          ...
          <br />
          <v-img :width="100" src="multimedia.jpg"></v-img>
          <h4 class="">Ingeniería Multimedia</h4>
          <p class="text-grey">
            Graduado en la Universidad de Alicante de Ingeniería Multimedia.
            Especializado en el itinerario de contenidos.
          </p>
          <br />
          <v-img :width="150" src="linguaskill.png" class="mt-6"></v-img>
          <h4 class="">Inglés B2</h4>
          <p class="text-grey">
            Ingles B2 (First) certificado por Linguaskill.
          </p>
        </v-col>
        <v-col align-self="center" cols="8" sm="3" class="mx-16">
          <h3 class="text-decoration-underline">Experiencia</h3>
          <br />
          ...
          >
            <v-card-item>
              <div>
                ...
                <div class="text-h6 mb-1">Portfolio</div>
                <v-img :width="700" src="portfolio.png"></v-img>
                <div class="body-2 mt-3 mb-2">Mi portafolio</div>
              </div>
            </v-card-item>
        ...
        <v-col align-self="center" cols="8" sm="4" class="mx-16 mb-8">
          ...
          >
            <v-card-item>
              <div>
                <div class="text-overline mb-1"></div>
                <div class="text-h6 mb-1">Eventua</div>
                <v-img :width="700" src="eventua_web.png"></v-img>
                <div class="body-2 mx-4 mt-3 mb-2 subheading">
                  Proyecto universitario grupal de final de carrera. Consiste de
                  un gestor de eventos de la universidad de Alicante creado
                  desde cero (Front-end, Back-end y Motor Gráfico)
                </div>
              </div>
            </v-card-item>
